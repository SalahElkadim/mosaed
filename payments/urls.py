...
from .views import (
    ...
    ProviderWalletView,PaymentRequestByBookingView,CustomerPointsTransactionListView,
...
urlpatterns = [
    ...
    path('customer/points-wallet/transactions/', CustomerPointsTransactionListView.as_view()),
